...
public class SerialNativeInterface {
	 ...
	 * @param useTIOCEXCL
	 *            enable/disable using of <b>TIOCEXCL</b>. Take effect only on
	 *            *nix based systems
	 * 
	 ...
	 * @param flags
	 *            additional Native settings. Take effect only on *nix based
	 *            systems
	 * 
	 ...
	 *         their values (<b>events[i][0] - event type</b>, <b>events[i][1] -
	 *         event value</b>).
	 */
